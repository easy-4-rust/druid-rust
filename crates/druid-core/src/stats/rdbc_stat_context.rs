//! 对应 Java 类：`com.alibaba.druid.stat.RdbcStatContext`。

/// 当前执行上下文携带的 RDBC 统计元数据。
///
/// 对应 Java: `com.alibaba.druid.stat.RdbcStatContext`。Java nullable 字段映射为
/// `Option<String>`，对象本身不依赖日志框架。
#[derive(Debug, Clone, Default, PartialEq, Eq)]
pub struct RdbcStatContext {
    name: Option<String>,
    file: Option<String>,
    sql: Option<String>,
