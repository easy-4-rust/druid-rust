...
`druid-toasty/tests/toasty_connection_adapter_test.rs` 验收。
...
| ID | 语义 | 证据 | 状态 |
| :--- | :--- | :--- | :--- |
| WRAP-BOUND-001 | Toasty 是 `druid` 内置实现 | `druid::toasty` 重导出，wrapper 不重导出 | PASS |
| WRAP-BOUND-002 | SQLx/RBDC 是可选 direct adapter | 具名子 crate/facade | PASS |
