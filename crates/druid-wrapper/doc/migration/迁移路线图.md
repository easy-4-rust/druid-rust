...
> Rust 目标：`crates/druid-wrapper`，并归口 RBDC、SQLx、bb8、deadpool crates  
> 日期：2026-07-28
...
| 维度 | Java | Rust | 当前 |
| :--- | :--- | :--- | :--- |
| 生产对象 | 13 | wrapper facade 1 + 子 crate 源文件 13 | PARTIAL |
...
| 阶段 | 内容 | 验收 | 当前 |
| :--- | :--- | :--- | :--- |
| W0 | facade + 子 crate 归口 | workspace/API 编译 | 已建立 |
...
2026-07-28 实测：wrapper facade 的 2 个 SQLite 纵向用例、SQLx 的 5 个、
bb8 的 5 个、deadpool 的 5 个实库用例全部通过；加入 Toasty 内置标准实现后，
全 workspace 431/431 通过。
