...
impl DruidPooledConnection {
    ...
    async fn prepare_from_key(
        ...
        let statement_holder = if let Some(statement_holder) = cached {
            statement_holder
        } else {
...
impl PhysicalConnection for DruidPooledConnection {
    ...
    fn transaction_isolation(&self) -> u8 {
        self.holder
            ...
            .map_or(
                2,
                super::physical_connection::PhysicalConnection::transaction_isolation,
            )
    }
    ...
    fn holdability(&self) -> i32 {
        self.holder
            ...
            .map_or(
                0,
                super::physical_connection::PhysicalConnection::holdability,
            )
    }
