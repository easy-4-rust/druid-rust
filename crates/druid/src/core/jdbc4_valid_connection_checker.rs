...
/// JDBC 4 `Connection#isValid` 的 Rust Adapter。
///
/// 对应 Java: `com.alibaba.druid.pool.JDBC4ValidConnectionChecker`。Rust
/// `PhysicalConnection#ping` 是各驱动对原生 `isValid` 的最小等价边界。
#[derive(Clone, Copy, Debug, Default)]
pub struct Jdbc4ValidConnectionChecker;

#[async_trait::async_trait]
impl ValidConnectionChecker for Jdbc4ValidConnectionChecker {
...
pub use Jdbc4ValidConnectionChecker as PingConnectionChecker;
