//! 对应 Java：`com.alibaba.druid.proxy.jdbc.NClobProxyImpl`。

use super::{ClobProxy, ClobProxyImpl, FilterChain, JdbcClob, JdbcNClob, NClobProxy};
use std::ops::Deref;
use std::sync::Arc;
...
impl NClobProxyImpl {
    /// 创建 NClob Proxy。
    #[must_use]
    pub fn new(connection_id: u64, n_clob: JdbcNClob, filter_chain: Arc<FilterChain>) -> Self {
