//! 对应 Java：`com.alibaba.druid.proxy.rdbc.RdbcParameterNull`。

use super::{RdbcParameter, RdbcParameterValue};

/// 带 SQL 类型的 NULL 参数。
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct RdbcParameterNull(i32);

impl RdbcParameterNull {
    /// `Types.CHAR`。
...
impl RdbcParameter for RdbcParameterNull {
