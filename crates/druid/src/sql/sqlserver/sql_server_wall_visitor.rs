//! 对应 Java：`com.alibaba.druid.wall.spi.SQLServerWallVisitor`。
...
/// SQL Server Wall 方言 Visitor。
pub struct SqlServerWallVisitor<'a> {
    base: WallVisitorBase<'a>,
}

impl<'a> SqlServerWallVisitor<'a> {
    /// 绑定 SQL Server Provider。
    #[must_use]
...
impl WallVisitor for SqlServerWallVisitor<'_> {
