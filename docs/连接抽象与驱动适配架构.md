...
| `druid-wrapper/src/sqlx_bb8` | `druid-sqlx-bb8` | Bridge | `SqlxBb8Pool`、`SqlxBb8ConnectionManager`、`PhysicalConnectionLease` | bb8 pool owned lease | 已移除 native factory 角色 |
| `druid-wrapper/src/sqlx_deadpool` | `druid-sqlx-deadpool` | Bridge | `SqlxDeadpoolPool`、`SqlxDeadpoolConnectionManager`、`PhysicalConnectionLease` | deadpool Object | 已移除 native factory 角色 |
